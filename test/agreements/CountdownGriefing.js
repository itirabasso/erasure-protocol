...
describe("CountdownGriefing", async function() {
  ...
  before(async () => {
    ...
    // this.CountdownGriefing = await run("erasure:deploy-factory", {
    //   template: 1,
    //   factory: 1,
    //   registry: 1,
    //   signer: 1
    ...
    await this.MockNMR.mintMockTokens(
      counterparty,
