...
async function createDeployer() {
  ...
  // return new etherlime.EtherlimeGanacheDeployer(accounts[accounts.length - 1].secretKey);
}
...
//   const deployer = createDeployer();
  ...
  // const MockNMR = env.erasure.getContractInstance(env.erasure.deploySetup.nmrToken, nmrAddress )
  //deployer.wrapDeployedContract(MockNMR_artifact, nmrAddress);
  return [undefined, MockNMR];
}
